...
//    case UL_DBPSK_50:
    ...
    case UL_DBPSK_3200_PROT_D:
        ...
        AX5043_IFFREQ1                 = 0x03;
        AX5043_IFFREQ0                 = 0x5C;
        AX5043_DECIMATION              = 0x0C;
        AX5043_RXDATARATE2             = 0x00;
        AX5043_RXDATARATE1             = 0x2A;
        AX5043_RXDATARATE0             = 0x51;
        AX5043_MAXDROFFSET2            = 0x00;
        AX5043_MAXDROFFSET1            = 0x00;
        AX5043_MAXDROFFSET0            = 0x00;
        AX5043_MAXRFOFFSET2            = 0x80;
    ...
    case UL_PSK_5000:
        ...
        AX5043_IFFREQ1                 = 0x00;
        AX5043_IFFREQ0                 = 0xFC;
        AX5043_DECIMATION              = 0x20;
        AX5043_RXDATARATE2             = 0x00;
        AX5043_RXDATARATE1             = 0x28;
        AX5043_RXDATARATE0             = 0xA0;
        AX5043_MAXDROFFSET2            = 0x00;
        AX5043_MAXDROFFSET1            = 0x00;
        AX5043_MAXDROFFSET0            = 0x00;
        AX5043_MAXRFOFFSET2            = 0x80;
...
const uint32_t __code dl_band1_axradio_phy_chanfreq[1] = { 0x213b13b1 };
const uint8_t __code dl_band1_axradio_phy_chanpllrnginit[1] = { 0x0a };
const uint8_t __code dl_band1_axradio_phy_chanvcoiinit[1] = { 0x99 };
...
const uint16_t __code dl_axradio_phy_preamble_wor_longlen = 1; // wor_longlen + wor_len totals to 240.0ms plus 328bits
...
//framing
const uint8_t __code dl_axradio_framing_maclen = 2;
const uint8_t __code dl_axradio_framing_addrlen = 1;
...
const uint8_t __code dl_axradio_framing_synclen = 32;
const uint8_t __code dl_axradio_framing_syncword[] = { 0x33, 0x55, 0x33, 0x55};
const uint8_t __code dl_axradio_framing_syncflags = 0x18;
const uint8_t __code dl_axradio_framing_enable_sfdcallback = 0;

const uint32_t __code dl_axradio_framing_ack_timeout = 3117; // 4868.5ms in wtimer0 units (640Hz)
const uint32_t __code dl_band1_axradio_framing_ack_timeout = 3230; // 5044.5ms in wtimer0 units (640Hz)


const uint32_t __code dl_axradio_framing_ack_delay = 313; // 1.0ms in wtimer1 units (20MHz/64)
const uint8_t __code dl_axradio_framing_ack_retransmissions = 0;
const uint8_t __code dl_axradio_framing_ack_seqnrpos = 0xff;

const uint8_t __code dl_axradio_framing_minpayloadlen = 0; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured
const uint8_t __code dl_band1_axradio_framing_minpayloadlen = 1; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured

//WOR
const uint16_t __code dl_axradio_wor_period = 128;

// synchronous mode
const uint32_t __code dl_axradio_sync_period = 191103; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code dl_axradio_sync_xoscstartup = 49;
const uint32_t __code dl_axradio_sync_slave_syncwindow = 573309; // 17.496s
...
const int16_t __code dl_axradio_sync_slave_maxperiod = 4047; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code dl_axradio_sync_slave_rxadvance[] = { 112547, 112464, 113979 };// 3434.650ms, 3432.117ms, 3478.351ms
const uint32_t __code dl_axradio_sync_slave_rxwindow[] = { 113086, 112920, 115950 }; // 3451.099ms, 3446.033ms, 3538.501ms
const uint32_t __code dl_axradio_sync_slave_rxtimeout = 148767; // 4540.0ms, maximum duration of a packet
...
const uint32_t __code psk500_band1_axradio_phy_chanfreq[1] = { 0x213b13b1 };
const uint8_t __code psk500_band1_axradio_phy_chanpllrnginit[1] = { 0x0a };
const uint8_t __code psk500_band1_axradio_phy_chanvcoiinit[1] = { 0x99 };
...
//framing
const uint8_t __code psk500_axradio_framing_maclen = 2;
const uint8_t __code psk500_axradio_framing_addrlen = 1;
...
const uint8_t __code psk500_axradio_framing_synclen = 32;
const uint8_t __code psk500_axradio_framing_syncword[] = { 0x33, 0x55, 0x33, 0x55};
...
const uint32_t __code psk500_axradio_framing_ack_timeout = 1249; // 1948.9ms in wtimer0 units (640Hz)
const uint32_t __code psk500_band1_axradio_framing_ack_timeout = 1294; // 2019.3ms in wtimer0 units (640Hz)

const uint32_t __code psk500_axradio_framing_ack_delay = 313; // 1.0ms in wtimer1 units (20MHz/64)
const uint8_t __code psk500_axradio_framing_ack_retransmissions = 0;
const uint8_t __code psk500_axradio_framing_ack_seqnrpos = 0xff;

const uint8_t __code psk500_axradio_framing_minpayloadlen = 0; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured
const uint8_t __code psk500_band1_axradio_framing_minpayloadlen = 1; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured

//WOR
const uint16_t __code psk500_axradio_wor_period = 128;

// synchronous mode
const uint32_t __code psk500_axradio_sync_period = 191103; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code psk500_axradio_sync_xoscstartup = 49;
const uint32_t __code psk500_axradio_sync_slave_syncwindow = 573309; // 17.496s
...
const int16_t __code psk500_axradio_sync_slave_maxperiod = 4047; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code psk500_axradio_sync_slave_rxadvance[] = { 45110, 45027, 45657 };// 1376.647ms, 1374.114ms, 1393.340ms
const uint32_t __code psk500_axradio_sync_slave_rxwindow[] = { 45354, 45188, 46448 }; // 1384.094ms, 1379.028ms, 1417.480ms
const uint32_t __code psk500_axradio_sync_slave_rxtimeout = 59507; // 1816.0ms, maximum duration of a packet

/*----------------------------psk5000_axradio-------------------------------------*/
const uint8_t __code psk5000_axradio_phy_pn9 = 0;
const uint8_t __code psk5000_axradio_phy_nrchannels = 1;
const uint32_t __code psk5000_axradio_phy_chanfreq[1] = { 0x11276277 };
const uint8_t __code psk5000_axradio_phy_chanpllrnginit[1] = { 0x09 };
const uint8_t __code psk5000_axradio_phy_chanvcoiinit[1] = { 0x97 };
const uint32_t __code psk5000_band1_axradio_phy_chanfreq[1] = { 0x213b13b1 };
const uint8_t __code psk5000_band1_axradio_phy_chanpllrnginit[1] = { 0x0a };
const uint8_t __code psk5000_band1_axradio_phy_chanvcoiinit[1] = { 0x99 };

uint8_t __xdata psk5000_axradio_phy_chanpllrng[1];
uint8_t __xdata psk5000_axradio_phy_chanvcoi[1];
const uint8_t __code psk5000_axradio_phy_vcocalib = 0;
const int32_t __code psk5000_axradio_phy_maxfreqoffset = 807;
const int8_t __code psk5000_axradio_phy_rssioffset = 64;
// axradio_phy_rssioffset is added to AX5043_RSSIREFERENCE and subtracted from chip RSSI value to prevent overflows (8bit RSSI only goes down to -128)
// axradio_phy_rssioffset is also added to AX5043_RSSIABSTHR
const int8_t __code psk5000_axradio_phy_rssireference = 0xF9 + 64;
const int8_t __code psk5000_axradio_phy_channelbusy = -99 + 64;
const uint16_t __code psk5000_axradio_phy_cs_period = 7; // timer0 units, 10ms
const uint8_t __code psk5000_axradio_phy_cs_enabled = 0;
const uint8_t __code psk5000_axradio_phy_lbt_retries = 0;
const uint8_t __code psk5000_axradio_phy_lbt_forcetx = 0;
const uint16_t __code psk5000_axradio_phy_preamble_wor_longlen = 3; // wor_longlen + wor_len totals to 240.0ms plus 328bits
const uint16_t __code psk5000_axradio_phy_preamble_wor_len = 160;
const uint16_t __code psk5000_axradio_phy_preamble_longlen = 1;
const uint16_t __code psk5000_axradio_phy_preamble_len = 72;
const uint8_t __code psk5000_axradio_phy_preamble_byte = 0x7e;
const uint8_t __code psk5000_axradio_phy_preamble_flags = 0x38;
const uint8_t __code psk5000_axradio_phy_preamble_appendbits = 0;
const uint8_t __code psk5000_axradio_phy_preamble_appendpattern = 0x00;

//framing
const uint8_t __code psk5000_axradio_framing_maclen = 2;
const uint8_t __code psk5000_axradio_framing_addrlen = 1;
const uint8_t __code psk5000_axradio_framing_destaddrpos = 1;
const uint8_t __code psk5000_axradio_framing_sourceaddrpos = 0xff;
const uint8_t __code psk5000_axradio_framing_lenpos = 0;
const uint8_t __code psk5000_axradio_framing_lenoffs = 0;
const uint8_t __code psk5000_axradio_framing_lenmask = 0xff;
const uint8_t __code psk5000_axradio_framing_swcrclen = 0;

const uint8_t __code psk5000_axradio_framing_synclen = 32;
const uint8_t __code psk5000_axradio_framing_syncword[] = { 0x33, 0x55, 0x33, 0x55};
const uint8_t __code psk5000_axradio_framing_syncflags = 0x18;
const uint8_t __code psk5000_axradio_framing_enable_sfdcallback = 0;

const uint32_t __code psk5000_axradio_framing_ack_timeout = 128; // 197.1ms in wtimer0 units (640Hz)
const uint32_t __code psk5000_band1_axradio_framing_ack_timeout = 132; // 204.2ms in wtimer0 units (640Hz)

const uint32_t __code psk5000_axradio_framing_ack_delay = 313; // 1.0ms in wtimer1 units (20MHz/64)
const uint8_t __code psk5000_axradio_framing_ack_retransmissions = 0;
const uint8_t __code psk5000_axradio_framing_ack_seqnrpos = 0xff;

const uint8_t __code psk5000_axradio_framing_minpayloadlen = 0; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured
const uint8_t __code psk5000_band1_axradio_framing_minpayloadlen = 1; // must be set to 1 if the payload directly follows the destination address, and a CRC is configured

//WOR
const uint16_t __code psk5000_axradio_wor_period = 128;

// synchronous mode
const uint32_t __code psk5000_axradio_sync_period = 191103; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code psk5000_axradio_sync_xoscstartup = 49;
const uint32_t __code psk5000_axradio_sync_slave_syncwindow = 573309; // 17.496s
const uint32_t __code psk5000_axradio_sync_slave_initialsyncwindow = 5898240; //180.000s
const uint32_t __code psk5000_axradio_sync_slave_syncpause = 19660800; // 600.000s
const int16_t __code psk5000_axradio_sync_slave_maxperiod = 4047; // in (2^SYNC_K1) * wtimer0 units
const uint8_t __code psk5000_axradio_sync_slave_resyncloss = 11;  // resyncloss is one more than the number of missed packets to cause a resync
// window 0 is the first window after synchronisation
// window 1 is the window normally used when there are no lost packets
// window 2 is used after one packet is lost, etc
const uint8_t __code psk5000_axradio_sync_slave_nrrx = 3;
const uint32_t __code psk5000_axradio_sync_slave_rxadvance[] = { 4671, 4565, 4664 };// 142.547ms, 139.313ms, 142.334ms
const uint32_t __code psk5000_axradio_sync_slave_rxwindow[] = { 4762, 4550, 4748 }; // 145.294ms, 138.825ms, 144.867ms
const uint32_t __code psk5000_axradio_sync_slave_rxtimeout = 5951; // 181.6ms, maximum duration of a packet

/*----------------------------FAST DOWNLINK-------------------------------------*/
// physical layer
const uint8_t __code fastdl_axradio_phy_pn9 = 0;
const uint8_t __code fastdl_axradio_phy_nrchannels = 1;
const uint32_t __code fastdl_axradio_phy_chanfreq[1] = { 0x11276277 };
const uint8_t __code fastdl_axradio_phy_chanpllrnginit[1] = { 0x09 };
const uint8_t __code fastdl_axradio_phy_chanvcoiinit[1] = { 0x97 };
const uint32_t __code fastdl_band1_axradio_phy_chanfreq[1] = { 0x213b13b1 };
const uint8_t __code fastdl_band1_axradio_phy_chanpllrnginit[1] = { 0x0a };
const uint8_t __code fastdl_band1_axradio_phy_chanvcoiinit[1] = { 0x99 };
...
const uint16_t __code fastdl_axradio_phy_preamble_wor_longlen = 28; // wor_longlen + wor_len totals to 240.0ms plus 328bits
...
//framing
const uint8_t __code fastdl_axradio_framing_maclen = 2;
const uint8_t __code fastdl_axradio_framing_addrlen = 1;
...
const uint32_t __code fastdl_axradio_framing_ack_timeout = 14; // 19.4ms in wtimer0 units (640Hz)
...
// synchronous mode
const uint32_t __code fastdl_axradio_sync_period = 81920; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code fastdl_axradio_sync_xoscstartup = 49;
const uint32_t __code fastdl_axradio_sync_slave_syncwindow = 245760; // 7.500s
...
const int16_t __code fastdl_axradio_sync_slave_maxperiod = 2649; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code fastdl_axradio_sync_slave_rxadvance[] = { 534, 463, 517 };// 16.279ms, 14.112ms, 15.760ms
const uint32_t __code fastdl_axradio_sync_slave_rxwindow[] = { 574, 432, 540 }; // 17.500ms, 13.167ms, 16.463ms
const uint32_t __code fastdl_axradio_sync_slave_rxtimeout = 1009; // 30.8ms, maximum duration of a packet
