...
extern void assert(s);
extern long time();
extern int signbit(double n);
extern int isfinite(double n);
extern int isnan(double n);
extern int isinf(double n);
...
//#define JS_STACKSIZE 32	/* value stack size */
//#define JS_ENVLIMIT 64		/* environment stack size */
//#define JS_TRYLIMIT 64		/* exception stack size */
#define JS_ENVLIMIT 16		/* environment stack size */
#define JS_TRYLIMIT 16		/* exception stack size */
